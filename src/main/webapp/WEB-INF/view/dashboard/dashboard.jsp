                  ...
                  <br>
                        ...
                        <div class="fixed-table-body">      
                              <table width="100%" class="col" border=0>
                                 ...
                                 <tbody>
                                      ...
                                      <tr> 
                                          <td>
                                          <!-- v-model : 폼에 대한 입력과 변수를 '양방향'으로 바인딩하는 v-model 디렉티브 제공 SI -->
                                          <!-- @(v-on) : 이벤트 핸들링, click과 같은 이벤트를 설정할 때 사용, @는 약어 SI -->
                                          <!-- v-text, v-html : 속성값을 그대로 출력 / html 적용해서 출력 -->
                                          <!-- 위 내용은 'vue 디렉티브'로 검색하면 나옴 -->
                                      ...
                                      <tr> 
                                          <td>
                                          <!-- v-on:input / @input => 한글을 바인딩할땐 한글자씩 밀리지 않아서 이걸 사용. 영문는 v-model을 쓰면 똑같은 효과 비벼지는데.. -->
                                             숫자 : <input type="text" class="inputTxt p100" name="inputnum" id="inputnum" v-model="inputnum"  v-on:input="inputkey($event)" />
                                             한글 : <input type="text" class="inputTxt p100" @input="changeKeyword" />
                                         </td>
                                         <td>
                                              {{ inputnum }}       
                                              <!-- v-model 말고 v-on:input(@input)으로 연결해서 한글바인딩 바로 해보자 SI 20220628 -->
                                              {{ keyword }}
                     ...
                     <br>
                        ...
                        <div>
                           ...
                           <div>
                           <!-- v- => 디렉티브, vue에서 제공하는 특수 속성임을 나타내는 접두어 SI -->
                           <!-- v-bind는 렌더링 된 DOM을 바인딩된 속성의 최신 상태로 계속 유지한다( 동기화가 된다는 뜻? ) -->
