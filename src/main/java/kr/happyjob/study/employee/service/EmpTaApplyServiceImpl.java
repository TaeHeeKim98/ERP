...
public class EmpTaApplyServiceImpl implements EmpTaApplyService {
	...
	/*로그인한 사람의 휴가 신청 잔여 횟수*/
	public EmpTaApplyRemainVacModel vacCnt(Map<String, Object> paramMap) throws Exception {
		
		EmpTaApplyRemainVacModel listLoginVac = empTaApplyDao.vacCnt(paramMap);
	...
	/*로그인한 사람 기본 정보 조회 */
	public EmpTaApplyModel empTaLoginInfo(Map<String, Object> paramMap) throws Exception{
		
		EmpTaApplyModel empDtlTaApplyModel = empTaApplyDao.empTaLoginInfo(paramMap);
	...
	@Override
	public void updateVac(Map<String, Object> paramMap) {

		empTaApplyDao.updateVac(paramMap);
		
	}

	@Override
	public int annualUse(Map<String, Object> paramMap) {
		int retundata = empTaApplyDao.annualUse(paramMap);
		return retundata;
	}

	@Override
	public void updateVacbancha(Map<String, Object> paramMap) {
		empTaApplyDao.updateVacbancha(paramMap);
		
	}

	@Override
	public void updateVacbancha2(Map<String, Object> paramMap) {
		empTaApplyDao.updateVacbancha2(paramMap);
