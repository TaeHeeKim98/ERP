...
public interface EmpTaApplyDao {
	...
	EmpTaApplyModel empTaLoginInfo(Map<String, Object> paramMap);
	...
	EmpTaApplyRemainVacModel vacCnt(Map<String, Object> paramMap);

	void updateVac(Map<String, Object> paramMap);

	int annualUse(Map<String, Object> paramMap);

	void updateVacbancha(Map<String, Object> paramMap);

	void updateVacbancha2(Map<String, Object> paramMap);
