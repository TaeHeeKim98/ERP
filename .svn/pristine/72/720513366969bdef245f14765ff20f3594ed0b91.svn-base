...
<script type="text/javascript">
	...
	/*계정과목관리 조회 - 검색조건*/
   function 	fn_AccTitlelist(currentPage) {
	   ...
	   var AccTitlelistcallback = function(returndata) {
		    fn_AccTitlelistcallback(returndata,currentPage) ;  
	   }	   
	   callAjax("/accounting/accTitleList.do", "post", "text", true, param, AccTitlelistcallback);	   	         
   }

   function fn_AccTitlelistcallback(returndata,currentPage) {	   
	   ...
	   var totalCnt = $("#totalCnt").val();
		...
		// 페이지 네비게이션 생성		
		var paginationHtml = getPaginationHtml(currentPage, totalCnt, pageSize, pageBlock, 'fn_AccTitlelist');
