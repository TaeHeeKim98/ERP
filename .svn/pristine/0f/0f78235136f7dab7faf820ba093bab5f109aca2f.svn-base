...
public class EmpTaCalendarModel {
	...
	private String detail_name; //휴가타입 상세코드
	...
	public String toString() {
		return "EmpTaCalendarModel [loginID=" + loginID + ", user_type=" + user_type + ", name=" + name + ", tel=" + tel
				+ ", dept_cd=" + dept_cd + ", job_cd=" + job_cd + ", dept_name=" + dept_name + ", vac_no=" + vac_no
				+ ", vac_bo=" + vac_bo + ", vac_stat=" + vac_stat + ", vac_rdate=" + vac_rdate + ", vac_type="
				+ vac_type + ", vac_re=" + vac_re + ", vac_sdate=" + vac_sdate + ", vac_edate=" + vac_edate
				+ ", vac_rere=" + vac_rere + ", detail_name=" + detail_name + ", vac_cnt=" + vac_cnt + ", title="
				+ title + ", start=" + start + ", end=" + end + ", url=" + url + ", color=" + color + ", textColor="
