...
public class EmpTaApplyModel {
	...
	private String vac_bo; 
	private String vac_stat;
	private String vac_rere;
	private String vac_re; 
	private String vac_tel;
	private String vac_rdate;
	...
	public String getVac_tel() {
		return vac_tel;
	}
	public void setVac_tel(String vac_tel) {
		this.vac_tel = vac_tel;
	}
