...
public interface EmpManagementDao {
	...
	void insertEmpManagement(Map<String, Object> paramMap) throws Exception;
	
	void insertEmpManagementfile(Map<String, Object> paramMap) throws Exception;
	
	void updateEmpManagementfile(Map<String, Object> paramMap) throws Exception;

	void insertHumanHistory(Map<String, Object> paramMap) throws Exception;

	void insertSalaryTable(Map<String, Object> paramMap) throws Exception;

	void insertDtlVacation(Map<String, Object> paramMap) throws Exception;
